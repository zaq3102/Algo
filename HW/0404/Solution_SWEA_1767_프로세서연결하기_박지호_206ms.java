...
public class Solution_SWEA_1767_프로세서연결하기_박지호_206ms {
...
// 벽에 붙은 애들 빼주고
// 벽에서 한칸 떨어진 애들 중에서 벽에 바로 이을수 있는 애들 빼주고
// 남은 코어들을 조합으로 풀어본다
// 코어의 조합을 구성할때에는 갈수있는 방향이 1개인 코어부터 우선적으로 정한다

// 조합으로 방향별 조합을 구한 다음 선연결파트로 넘어가서 계산
