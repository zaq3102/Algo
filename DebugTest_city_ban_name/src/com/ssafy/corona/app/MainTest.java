...
public class MainTest {
 ...
 //<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		// 코로나19: 등록된 바이러스입니다.
		try {
			vmgr.add(new Mers(  "메르스15", 2, 1.5)); // Mers 확인
			vmgr.add(new Corona("코로나19", 3, 2)); // Corona 확인
			vmgr.add(new Corona("코로나19", 2, 2));
		} catch (DuplicatedException e) { // VirusMgrImpl 확인
		...
		for(Virus v:virus) {
			System.out.println(v); // Corona 확인
		}
		System.out.println();
		...
		// 코로나15: 미등록 바이러스입니다.
		try {
			Virus v=vmgr.search("코로나15"); // VirusMgrImpl 확인
 ...
 //<- 주석 해제 후 작성 : end /////////////////////////////////
		...
		PersonMgr pmgr=PersonMgrImpl.getInstance(); // PersonMgrImpl 확인
		System.out.println();		
...
//<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		// 이환자	32	010-0202-0002	과음	901	false
		// 강환자	23	010-0303-0003	오한	902	true
		pmgr.delete("오싸피"); // PersonMgrImpl 확인
...
//<- 주석 해제 후 작성 : end /////////////////////////////////
		...
		OrganizationMgr omgr=new OrganizationMgrImpl(); // OrganizationMgrImpl 확인
		System.out.println();
...
//<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		// 싸피병원	15	101	50	5
		// 질병관리청	200	충북 청주시
		Collections.sort(orgs); // Organization 확인
		for(Organization org : orgs) {
			System.out.println(org);
		}
		System.out.println();
		...
		// 싸피병원	15	101	50	5
		Organization org=omgr.search(new Hospital("싸피병원", 15, "001", 50, 5)); // OrganizationMgrImpl 확인
		System.out.println(org);
		System.out.println();
//<- 주석 해제 후 작성 : end /////////////////////////////////
