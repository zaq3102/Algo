...
public class Main_BOJ_15683_감시_G4_박지호_836ms {
...
// 1번 한쪽 2번 수평두방향 3번 직각두방향  4번 세방향 5번 전방위
// CCTV 최대 8개

// 중복순열가지고함
// ex) CCTV 3개 => 각 CCTV 모드를 0~4 로 두고 중복순열 한다

// CCTV가 위치한 자리 역시 사각지대로 판단해야됨

// 최종 로직 : DFS를 통해 중복순열 원리로 CCTV를 고른 뒤 BFS를 통해 CCTV가 감시가능한 구역을 체크
//			이후 사각지대를 구한다